...
def training_loop(
    ...
    common_kwargs = dict(z_dim_id=256, z_dim_style=256, w_dim_id=256, w_dim_style=256, c_dim=training_set.label_dim, img_resolution=training_set.resolution, img_channels=training_set.num_channels)
